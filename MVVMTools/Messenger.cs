...
namespace MVVM
{
    public class Messenger
    {
        ...
        {
            Unregister<T>(recipient, null, typeof(T));
        }
        ...
        /// <param name="recipient"></param>
        /// <param name="context"></param>
        public void Unregister<T>(object recipient, object context, Type messageType)
        {
            object action;
            var key = new MessengerKey(recipient, context, messageType);
        ...
        protected class MessengerKey
        {
            ...
            /// <param name="recipient"></param>
            /// <param name="context"></param>
            public MessengerKey(object recipient, object context, Type messageType)
            {
                Recipient = recipient;
                Context = context;
            ...
            /// <returns></returns>
            protected bool EqualsMessengerKey(MessengerKey other)
            {
                return Equals(Recipient, other.Recipient) && Equals(Context, other.Context) && Equals(MessageType, other.MessageType);
            }
            ...
            public override bool Equals(object obj)
            {
                ...
                return EqualsMessengerKey((MessengerKey)obj);
            }
            ...
            public override int GetHashCode()
            {
                unchecked
                {
                    return ((Recipient != null ? Recipient.GetHashCode() : 0) * 397) ^ (Context != null ? Context.GetHashCode() : 0) ^ (MessageType != null ? MessageType.GetHashCode() : 0);
                }
            }
        }
    }
